                                ...
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <hr>
                                            <form:form method="post" modelAttribute="productUpdate" action="/admin/product/update" enctype="multipart/form-data">
                                                <form:hidden path="id" />
                                                <div class="row">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <img src="" alt="img preview" style="max-height: 250px;" id="imgPreview">
                                                </div>
