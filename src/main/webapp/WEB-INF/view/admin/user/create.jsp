                                            ...
                                            <form:form method="post" modelAttribute="newUser" action="/admin/user/create" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <form:input type="password" class="form-control ${not empty errPassword ? 'is-invalid' : ''}" path="password" /> ${errPassword}
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mb-3 col-12 col-md-6 ">
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <form:input type="text" class="form-control ${not empty errorFullName ? 'is-invalid' : ''}" path="fullName" /> ${errorFullName}
                                                    </div>
                                                </div>
