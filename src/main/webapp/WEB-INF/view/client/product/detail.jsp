                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form action="/add-product-from-view-detail" method="post" modelAttribute="product">
                                            ...
                                            <input class="form-control d-none" type="text" name="id" value="${product.id}" />
                                            <input class="form-control d-none" type="text" name="quantity" value="1" id="cartDetails0.quantity" />
