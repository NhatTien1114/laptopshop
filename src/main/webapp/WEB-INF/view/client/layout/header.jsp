                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white mx-5 justify-content-between" id="navbarCollapse">
                            ...
                            <div class="dropdown my-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-4" aria-labelledby="dropdownMenuLink">
                                    <li class="d-flex align-items-center flex-column" style="min-width: 300px;">
                                        <img style="width: 150px; height: 150px; border-radius: 50%; overflow: hidden;" src="/image/avatar/${sessionScope.avatar}" />
                        ...
                        <c:if test="${empty pageContext.request.userPrincipal}">
                            <a href="/login" class="btn btn-primary py-2 px-4" style="color: white">Đăng nhập</a>
                        </c:if>
                    </div>
                </nav>
            </div>
