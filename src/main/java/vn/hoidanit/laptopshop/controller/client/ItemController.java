...
public class ItemController {
    ...
    public String getProductPage(Model model, @PathVariable long id) {
        Product product = this.productService.fetchProductsById(id).get();
    ...
    public String handleConfirmCheckout(@ModelAttribute("cart") Cart cart) {
        List<CartDetail> cartDetails = cart == null ? new ArrayList<CartDetail>() : cart.getCartDetails();
        this.productService.handleUpdateCartBeforeCheckou(cartDetails);
    ...
    public String handlePlaceOrder(HttpServletRequest request,
        ...
        this.productService.handleOrder(user, session, receiverName, receiverPhone, receiverAddress);
